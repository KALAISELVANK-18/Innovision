        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream:FirebaseFirestore.instance.collection(FirebaseAuth.instance.currentUser!.email.toString()).doc("posts").collection("posts").snapshots(),
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child: Text("Reports",style: GoogleFonts.aBeeZee(textStyle: TextStyle(
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Container(
                                                    width:180,
                                                    child: Text(nn[index]["title"],textAlign: TextAlign.start,style: GoogleFonts.aBeeZee(textStyle: TextStyle(
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Container(
                                                        width:180,
                                                        child: Text(formatTimestamp( nn[index]["time"].seconds),style: GoogleFonts.aBeeZee(textStyle: TextStyle(
                                                          fontWeight: FontWeight.bold,
                                                        )))),
                                                  ],
                                                )
